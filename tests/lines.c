...
void test_polygon(ei_surface_t surface, ei_rect_t* clipper) {
	...
	/* Initialisation */
	pts[0].point = ei_point(500, 300);
	pts[1].point = ei_point(600, 250);
	pts[2].point = ei_point(700, 350);
	pts[3].point = ei_point(650, 400);
	pts[4].point = ei_point(600, 375);
	pts[5].point = ei_point(500, 500);
...
void test_edge_polygon(ei_surface_t surface, ei_rect_t* clipper) {
...
int ei_main(int argc, char** argv)
{
	...
	ei_rect_t		clipper		= ei_rect(ei_point(150, 150), ei_size(500, 300));
	clipper_ptr		= &clipper;
	...
	test_edge_polygon(main_window, clipper_ptr);
