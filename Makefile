...
LIBEIOBJS	:= ${OBJDIR}/ei_application.o ${OBJDIR}/ei_draw.o ${OBJDIR}/ei_draw_shape.o \
			   ${OBJDIR}/ei_widget.o ${OBJDIR}/ei_widget_frame.o ${OBJDIR}/ei_placer.o \
			   ${OBJDIR}/ei_widget_button.o ${OBJDIR}/ei_widget_toplevel.o ${OBJDIR}/ei_widget_entry.o
...
TARGETS		=	${LIBEI} \
			minimal lines frame button hello_world puzzle two048 form
all : ${TARGETS}
...
form : ${OBJDIR}/form.o ${LIBEIBASE} ${LIBEI}
	${LINK} -o form ${LDFLAGS} ${OBJDIR}/form.o ${LIBEI} ${LIBS}

${OBJDIR}/form.o : ${TESTS}/form.c
	${CC} ${CCFLAGS} ${INCFLAGS} ${TESTS}/form.c -o ${OBJDIR}/form.o
